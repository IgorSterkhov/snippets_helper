...
**Used in:** Exec tab (command cards, already implemented), Tasks tab
(checkbox rows, pinned chips, collapsed link chips), Snippets tag and pinned
chips, Notes pinned chips
