...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::shortcuts::set_shortcut_pinned,
            commands::shortcuts::reorder_pinned_shortcuts,
            ...
            commands::ai::ai_chat,
            commands::ai::get_ai_provider_settings,
            commands::ai::save_ai_provider_settings,
            commands::ai::clear_ai_provider_settings,
            commands::ai::get_ai_provider_balance,
            commands::ai::get_ai_agent_settings,
            commands::ai::save_ai_agent_settings,
            commands::ai::get_ai_capabilities,
            commands::ai::preview_ai_prompt,
            commands::ai::save_ai_telegram_bot_settings,
            commands::ai::clear_ai_telegram_bot_settings,
            commands::ai::get_ai_telegram_status,
            commands::ai::poll_ai_telegram_once,
            commands::ai::unbind_ai_telegram_chat,
            commands::media::pick_media_file,
            commands::media::pick_html_file,
            commands::media::start_media_upload,
            commands::media::start_html_upload,
            ...
            commands::notes::reorder_pinned_notes,
            ...
            commands::exec::list_exec_command_counts,
            ...
            commands::whisper::whisper_stop_active,
            commands::whisper::whisper_cancel_active,
