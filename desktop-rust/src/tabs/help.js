...
const i18n = {
  en: {
    ...
    telegraph_share_desc: 'The Share dialog can publish notes and snippets to Telegra.ph as Telegram-friendly snapshot pages. The server creates a per-user Telegra.ph account automatically, keeps the access token server-side, and lets the desktop copy/open or update the published page. Interactive HTML Cards degrade to safe links back to the sandboxed HTML asset.',
