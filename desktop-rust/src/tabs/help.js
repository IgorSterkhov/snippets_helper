...
const i18n = {
  en: {
    ...
    telegraph_share_desc: 'The Share dialog can publish notes and snippets to Telegra.ph as Telegram-friendly snapshot pages. The sync API prepares the safe Telegra.ph content and stores page metadata, while the desktop native app performs the direct Telegra.ph publish/update so publishing still works when the server cannot reach Telegra.ph. Failures open a persistent dialog with copyable diagnostics. Interactive HTML Cards degrade to safe links back to the sandboxed HTML asset.',
