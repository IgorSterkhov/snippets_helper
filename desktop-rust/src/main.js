...
const TABS = [
  ...
  { id: 'finance',   label: 'Finance',   icon: '$',     sidebarIcon: 'outline:finance', sidebarIconTone: 'finance', loader: (el) => import('./tabs/finance.js').then(m => m.init(el)) },
  { id: 'sql',       label: 'SQL',       icon: '\u{1F5C3}', sidebarIcon: 'outline:sql', sidebarIconTone: 'sql', loader: (el) => import('./tabs/sql/sql-main.js').then(m => m.init(el)) },
  { id: 'superset',  label: 'Superset',  icon: 'logo:apachesuperset', sidebarIcon: 'logo:apachesuperset', sidebarIconTone: 'superset', loader: (el) => import('./tabs/superset/superset-main.js').then(m => m.init(el)) },
